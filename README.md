# Project 3 - *MyOnlyTweets*

**MyOnlyTweets** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
<img src='https://imgur.com/gW5Jbj2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
